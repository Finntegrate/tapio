...
class TestMarkdownVectorizer:
    ...
    @patch("tapio_ingest.vectorstore.vectorizer.find_markdown_files")
    ...
    @patch("tapio_ingest.vectorstore.vectorizer.read_markdown_file")
    @patch("tapio_ingest.vectorstore.vectorizer.Document")
