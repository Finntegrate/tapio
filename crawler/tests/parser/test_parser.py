...
class TestParser(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.input_dir = os.path.join(
            self.temp_dir, self.site_name, DEFAULT_DIRS["CRAWLED_DIR"]
        )
        self.output_dir = os.path.join(
            self.temp_dir, self.site_name, DEFAULT_DIRS["PARSED_DIR"]
        )
    ...
    def test_init(self):
        ...
        self.assertTrue(
            ...
            or os.path.abspath(self.parser.input_dir)
        ...
        self.assertTrue(
            ...
            or os.path.abspath(self.parser.output_dir)
    ...
    def test_convert_element_link_to_absolute(self):
        ...
        element3 = lxml_html.fromstring(
            '<a href="http://other-domain.com/page">Link</a>'
        )
        ...
        element4 = lxml_html.fromstring(
            '<a href="//cdn.example.com/script.js">Link</a>'
        )
